...
<head>
<meta charset="UTF-8">
<title>SearchView.jsp 소스 코딩</title>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>

<script type="text/javascript">
// [검색요청] 버튼 클릭하면 실행할 메서드를 정의합니다.
$(function() {
...
$("#searchBtn").click(function() {
	$.ajax({
		...
		// 마지막으로 요청 성공시 혹은 실패시 호출할 콜백 메서드를 설정합니다.
		success : sunFuncJson,// 요청 성공시 호출할 메서드 설정
		error : errFunc // 요청 실패시 호출할 메서드 설정
	});
});
});
// 검색 성공시 결과를 화면에  표시해 줍니다.
function sunFuncJson(d) { // 성공 시의 콜백 메서드 sunFuncJson() 입니다.
...
<body>
	...
	<!--  검색 결과가 출력되는 영역입니다. 다음의 자바스크립트 코드에서 결과로 받은 JSON 데이터를 파싱해서, 아래 영역에 채워주게 합니다. -->
