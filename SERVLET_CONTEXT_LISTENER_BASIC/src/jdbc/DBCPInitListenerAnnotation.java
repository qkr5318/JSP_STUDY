...
// @WebListener 애노테이션을 이용한 ServletContextListener 설정 시
// web.xml 파일에 jdbc.DBCPInitListenerAnnotation 클래스가
// <listener> 태그에 설정되어 있다면 주석 처리를 해줘야 합니다.
// 그리고, 아래에 @WebListener 애노테이션을 추가해 줘야 합니다.
// (아래 @WebListener 주석 풀어주시기 바랍니다)
@WebListener
public class DBCPInitListenerAnnotation implements ServletContextListener {  // 수정 (1)
