 ...
 * Generated at: 2023-01-06 04:44:44 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>WebSocket 활용 index.jsp 소스 코딩</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("    <form>\r\n");
      ...
      out.write("    \t// websocket는 호스트 명으로 지정합니다.\r\n");
      out.write("    \t// WebSocket 객체 생성(자동으로 접속을 시작합니다. onopen 함수 호출)\r\n");
      out.write("    \t// 본인 PC 포트를 적용합니다. (예시 : localhost:9005)\r\n");
      out.write("    \tvar webSocket = new WebSocket(\"ws://192.168.0.185:9005/websocket\");\r\n");
      ...
      out.write("\t\t\tmessageTextArea.value += \"Recieve From Server => \" + message.data + \"\\n\";\r\n");
      out.write("\t\t};\r\n");
      out.write("\t\t// Send 버튼을 누르면 호출되는 함수 정의\r\n");
      out.write("\t\tfunction sendMessage() {\r\n");
      out.write("\t\t\t// 송신 메시지를 작성하는 텍스트 박스 오브젝트를 취득합니다.\r\n");
      out.write("\t\t\tvar message = document.getElementById(\"textMessage\");\r\n");
      out.write("\t\t\t// 콘솔 텍스트에 메시지를 출력 처리 합니다.\r\n");
      out.write("\t\t\tmessageTextArea.value += \"Send to Server => \" + message.value + \"\\n\";\r\n");
      out.write("\t\t\t// WebSocket 서버에 메시지를 송신 처리 합니다.\r\n");
